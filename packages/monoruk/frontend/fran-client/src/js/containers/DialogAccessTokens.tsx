...
export type DialogProps = IntegrationStore & {widgets: WidgetsStore } & IntegrationActionsCreators;
...
const DialogAccessTokens = connect<IntegrationStore & { widgets: WidgetsStore }, IntegrationActionsCreators, {}>(mapStateToProps, mapDispatchToProps)(Container);
