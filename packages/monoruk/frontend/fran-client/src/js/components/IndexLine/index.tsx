...
class IndexLine extends React.Component<Props, {}> {
  state = {
    selectedItem: {
      label: getTitleParamFromConfig({index: this.props.index, indexAction: this.props.indexAction}).title,
      val1: this.props.index,
      val2: this.props.indexAction,
      value: getTitleParamFromConfig({index: this.props.index, indexAction: this.props.indexAction}).name
    },
