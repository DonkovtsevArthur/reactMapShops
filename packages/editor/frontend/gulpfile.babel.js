...
gulp.task('build.dev', gulp.series('clear', gulp.parallel('template', 'js', 'css', 'img', 'font')))
gulp.task('dev', gulp.parallel('watch', gulp.series('template', 'clear', 'build.dev', 'server')))

gulp.task(
	'build',
	gulp.series('clear', gulp.parallel('template', 'js.prod', 'css.prod', 'img.prod', 'font'))
)
